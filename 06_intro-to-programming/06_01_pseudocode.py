...
# Save all the names of the kittens in a list
# Iterate for every name on the list
# Inside the for loop print a message that each kitten is ready for adoption